...
export const VEHICLES: Record<VehicleId, VehicleDef> = {
  mtw: {
    ...
    drive: { accel: 400, maxSpeed: 440, reverseSpeed: 150, turnRate: 190, brake: 800, drag: 200, mass: 1, bodyRadius: 20 },
    equipment: ['barrier'],
  ...
  gkw: {
    ...
    drive: { accel: 200, maxSpeed: 340, reverseSpeed: 100, turnRate: 105, brake: 480, drag: 120, mass: 2.5, bodyRadius: 24 },
