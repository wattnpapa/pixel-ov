...
const objects = [
  { id: 10, name: 'spawn-depot', type: 'spawn', x: px(15) + 32, y: px(10) + 32, width: 0, height: 0, point: true, rotation: 0 },
  // Zivilfahrzeuge: Polyline als Rundkurs (Punkte relativ zum Objektursprung)
  route(11, 'route-ring', 'civil-car-a-top', 130, [[4, 4], [43, 4], [43, 28], [4, 28]]),
  route(12, 'route-inner', 'civil-car-b-top', 120, [[18, 4], [32, 4], [32, 16], [18, 16]]),
  route(13, 'route-south', 'civil-car-c-top', 140, [[4, 16], [32, 16], [32, 28], [4, 28]]),
];
function route(oid, name, sprite, speed, pts) {
  const [ox, oy] = pts[0];
  return {
    id: oid, name, type: 'route', x: px(ox) + 32, y: px(oy) + 32, width: 0, height: 0, rotation: 0,
